		...
		<div class="container">
			...
			<div class="flex flex-wrap lg:-mx-8">
				...
				<div class="w-full lg:w-8/12 px-0 lg:px-8">
					...
					<div class="content mb-10">
						<p><?php _e('Сайт HotelOdessa-Ukraine.com посвящен поиску комфортного жилья для отдыхающих на морских курортах Украины. Мы собрали большой каталог предложений жилья. Этот каталог включает в себя полную информацию о базах отдыха, пансионатах, отелях. Есть рейтинг, на который вы, посетители сайта, можете непосредственно повлиять. В каталоге есть реальные контактные данные, поэтому звоните, узнавайте актуальные цены и бронируйте себе жилье.', 'odessa'); ?></p>
						<p><?php _e('HotelOdessa-Ukraine.com - ваш незаменимый справочник по отелям Украины.', 'odessa'); ?></p>
					</div>
					<!-- END Главный текст -->
					<!-- Отель дня -->
			...
			<div class="mb-10">
				<div class="bg-gray-800 text-white text-center rounded-xl px-4 py-8">
					...
					<a href="<?php echo get_page_url('templates/add'); ?>" class="inline-block bg-blue-700 rounded-xl px-6 py-2"><?php _e('Добавить отель за 5 минут', 'odessa'); ?></a>
				</div>
			</div>
			<!-- END Добавить отель -->
