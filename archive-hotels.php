  ...
  <div class="container">
    <div class="welcome w-full h-48 relative mb-10">
      <div class="w-full h-48">
        <img src="https://hotelodessa-ukraine.com/wp-content/uploads/2021/12/hotels.jpeg" alt="" class="w-full h-full object-cover rounded-xl">
      </div>
      ...
      <div class="w-full h-full flex flex-col justify-center items-center absolute top-0 left-0 text-white z-1 ">
        ...
        <div class="opacity-75 text-xl italic font-bold">
          <?php _e('Все отели в нашем каталоге', 'odessa'); ?>
        </div>
      </div>
    </div>
